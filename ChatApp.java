...
public class ChatApp {
    ...
    static JLabel homel3 = new JLabel("");
    static JLabel homel4 = new JLabel("");
    static JLabel homel5 = new JLabel("");
    static JLabel homel6 = new JLabel("");
...
//HOME
        ...
        rb1.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e1) {
                ...
                String email = rt2.getText();
                String pwd = rt3.getText();
                String cpwd = rt4.getText();
                String mob = rt7.getText();
